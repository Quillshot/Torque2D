...
public:
    ...
    static RectI getStringElementRectI( const char* inString, const U32 index = 0 );
    static RectF getStringElementRectF( const char* inString, const U32 index = 0 );
...
public:
    ...
    /// Mouse-Events.
    virtual void onMouseEvent( const char* name, const GuiEvent& event, const t2dVector& worldMousePoint );
...
public:
    ...
    virtual void process(SimObject *object)
    {
        ...
        /// Post Event.
        t2dSceneObject* t2dobject = dynamic_cast<t2dSceneObject*>(object);
        if ( t2dobject )
           t2dobject->mPeriodicTimerID = Sim::postEvent( object, pEvent, Sim::getCurrentTime() + mTimerPeriod );
