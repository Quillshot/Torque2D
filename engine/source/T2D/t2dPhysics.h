...
public:
    ...
    void setNetLinearVelocity( const t2dVector& velocity );
    void setNetAngularVelocity( const F32& velocity );
	...
	static void getSupportingCornerNormal( const t2dVector* pVertices, const U32 numVertices, const U32 index, const t2dVector objectPosition, t2dVector& collisionNormal );
