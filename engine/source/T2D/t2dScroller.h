...
public:
    ...
    static bool setUseSourceRect(void* obj, const char* data) { static_cast<t2dScroller*>(obj)->setUseSourceRect(dAtob(data)); return false; };
	...
	void setUseSourceRect( bool bUseSourceRect ) { mUseSourceRect = bUseSourceRect; }
	...
	DECLARE_T2D_LOADSAVE_METHOD( t2dScroller, 5 );
