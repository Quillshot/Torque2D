...
public:
   ...
   void setSpeed(t2dSceneObject* object, F32 speed)
   {
      PathedObject* pathedObject = getPathedObject(object);
      if (pathedObject) pathedObject->setSpeed(speed, true);
   }
   void setMoveForward(t2dSceneObject* object, bool forward)
   {
      setDirection(object, forward ? 1 : -1);
   }
   void setDirection(t2dSceneObject* object, S32 direction)
   {
      PathedObject* pathedObject = getPathedObject(object);
      if (pathedObject) pathedObject->setStartDirection(direction, true);
   }
   void setOrient(t2dSceneObject* object, bool orient)
   {
      PathedObject* pathedObject = getPathedObject(object);
      if (pathedObject) pathedObject->setOrientToPath(orient, true);
   }
   void setRotationOffset(t2dSceneObject* object, F32 offset)
   {
      PathedObject* pathedObject = getPathedObject(object);
      if (pathedObject) pathedObject->setRotationOffset(offset, true);
   }
   void setLoops(t2dSceneObject* object, S32 loops)
   {
      PathedObject* pathedObject = getPathedObject(object);
      if (pathedObject) pathedObject->setTotalLoops(loops, true);
   }
   void setFollowMode(t2dSceneObject* object, ePathMode followMode)
   {
      PathedObject* pathedObject = getPathedObject(object);
