...
{
    // Sanity!
    AssertFatal( mSceneBinArray == NULL, "Cannot Create Container Bins; some already exist!" );
...
void t2dSceneContainer::addSceneObjectDirect( t2dSceneObject* pSceneObject2D, U32 minX, U32 minY, U32 maxX, U32 maxY )
{
    ...
    // Very Large Objects go into the Scene Overflow bin.  Overflow bin?
