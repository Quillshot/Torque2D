...
void t2dShapeVector::initPersistFields()
{
   Parent::initPersistFields();
	...
	const char*  in_pFieldname = "PolyList";
    const U32 in_fieldType = TypePoint2FVector;
    const dsize_t in_fieldOffset = Offset(mPolygonBasisList, t2dShapeVector);
    AbstractClassRep::SetDataNotify in_setDataFn = &setLineColour;
