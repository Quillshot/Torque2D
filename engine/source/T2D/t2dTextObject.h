...
public:
   ...
   /// Sets the bilinear filter settings of the text
   void	setBilinearFilter(bool bBilinear) { mUseBilinearFilter = bBilinear; }
   
   /// Gets the bilinear filter settings of the text
   bool	getBilinearFilter(void) { return mUseBilinearFilter; }
   
   /// Sets the snap to integer position settings of the text
   void	setSnapToIntegerPos(bool bSnap) { mSnapToIntegerPos = bSnap; }
   
   /// Gets the snap to integer position settings of the text
   bool	getSnapToIntegerPos(void) { return mSnapToIntegerPos; }

   /// Sets the no unicode setting of the text
   void	setNoUnicode(bool bNoUnicode) { mNoUnicode = bNoUnicode; }
   
   /// Gets the no unicode setting  of the text
   bool	getNoUnicode(void) { return mNoUnicode; }
   ...
   /// gets a proper approximation of the size of the text in pixels
...
private:
   ...
   /// Should the text use bilinear filtering?
   bool	mUseBilinearFilter;
   
   /// Should the text origin snap to an integer location
   bool	mSnapToIntegerPos;
   
   /// Is this font not supporting Unicode characters
   bool mNoUnicode;
   ...
   static bool setBilinearFilter( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setBilinearFilter( dAtob( data ) ); return false; };
   static bool setSnapToIntegerPos( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setSnapToIntegerPos( dAtob( data ) ); return false; };
   static bool setNoUnicode( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setNoUnicode( dAtob( data ) ); return false; };
   /// @}
};
