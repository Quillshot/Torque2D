...
public:
    ...
    const CDebugStats& getLastDebugStats( void ) const          { return mLastDebugStats; };
    CDebugStats&    getDebugStats( void )                       { return mDebugStats; };
    void            resetDebugStats( void )                     { mLastDebugStats = mDebugStats; mDebugStats.reset(); };
