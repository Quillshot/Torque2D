...
//----------------------------------------------------------------------------
ConsoleMethod( GuiAviBitmapCtrl, setFilename, void, 3, 3, "(string filename) Sets the filename for the control (note: legacy support. Use Theora)")
{
   object->setFilename(argv[2]);
}

//----------------------------------------------------------------------------
ConsoleMethod( GuiAviBitmapCtrl, play, void, 2, 2, "Start playback. (note: legacy support. Use Theora)")
{
   object->movieStart();
}

//----------------------------------------------------------------------------
ConsoleMethod( GuiAviBitmapCtrl, stop, void, 2, 2, "Stop playback.(note: legacy support. Use Theora)")
{
   object->movieStop();
}
