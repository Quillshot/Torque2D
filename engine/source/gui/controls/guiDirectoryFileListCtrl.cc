...
ConsoleMethod( GuiDirectoryFileListCtrl, setFilter, void, 3, 3, "([mask]) Set the current GuiDirectoryFileListCtrl filter.\n"
			  "@param mask The filter to set (space separted values)\n"
			  "@return No return value\n"
			  "@note %obj.setFilter([mask space delimited])")
{
...
ConsoleMethod( GuiDirectoryFileListCtrl, setPath, bool, 3, 4, "(path, [filter]) Directory to enumerate files from (without trailing slash)\n"
...
ConsoleMethod( GuiDirectoryFileListCtrl, getSelectedFiles, const char*, 2, 2, "()\n @return Returns a word separated list of selected file(s)" )
{
...
ConsoleMethod( GuiDirectoryFileListCtrl, getSelectedFile, const char*, 2, 2, "()\n @return Returns the currently selected file name" )
{
