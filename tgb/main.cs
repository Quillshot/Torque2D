...
// if not specified.
setCompanyAndProduct("GarageGames", "TorqueGameBuilder");
...
if( parseArgs() )
{
   ...
   else
   {
      ...
      // Query the loadLastProject pref before using the startupProject  [KNM | 07/28/11 | ITGB-131]
      //else if ($pref::loadLastProject )&& ($pref::startupProject !$= ""))
