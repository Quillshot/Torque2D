...
function LevelBuilderToolManager::initializeTools(%toolManager)
{
   ...
   {
      LevelBuilderToolManager::addButtonToBar( LevelBuilderToolBar, $LevelBuilder::GuiPath @ "/images/iconCompile2005", "openVS2008Project();", "Open Visual Studio 2008",true );      
      LevelBuilderToolManager::addButtonToBar( LevelBuilderToolBar, $LevelBuilder::GuiPath @ "/images/iconCompile2008", "openVS2010Project();", "Open Visual Studio 2010",true );      
   }
   ...
   LevelBuilderToolManager::addButtonToBar( LevelBuilderToolBar, $LevelBuilder::GuiPath @ "/images/iconPlay", "runGame();", "Play Scene" );
