if (!isObject(moveStopRightMouseClick))
{
   %behavior = new BehaviorTemplate(moveStopRightMouseClick)
   {
...
function moveStopRightMouseClick::onAddToScene(%this, %scenegraph) 
{
...
function moveStopRightMouseClick::onRightMouseDown(%this,%modifier,%worldPos,%clicks)
{
