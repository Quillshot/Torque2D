if (!isObject(onRightMouseHold_PlayEffect))
{
   %behavior = new BehaviorTemplate(onRightMouseHold_PlayEffect)
   {
...
function onRightMouseHold_PlayEffect::onAddToScene(%this, %scenegraph) 
{
...
function onRightMouseHold_PlayEffect::onRightMouseDown(%this,%modifier,%worldPos,%clicks)
{
   if (!%this.enable) return;
      %this.lastEffect = %this.playEffect();
}

function onRightMouseHold_PlayEffect::onRightMouseUp(%this,%modifier,%worldPos,%clicks)
{
   if (!%this.enable) return;
...
function onRightMouseHold_PlayEffect::playEffect( %this )
{      
   if(!%this.debugMode) echo("onRightMouseHold_PlayEffect::playEffect( ", %this,  " ) @ ", getSimTime() );
   %found = false;
