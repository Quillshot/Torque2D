...
//------------------------------------------------------
function exampleFrame3() // Designed for 800 x 600 Resolution
{
   // Select which frame to use
   mainScreenGui.configureFrame( 3, expandFilename("~/gui/images/protoBack3.png") );
   ...
   {
      // Damage Meter
      gameBackground.addIcon( 625, 450, 50, 50, expandFilename("~/gui/images/icons/damageIcon40.png") );
      gameBackground.addVerticalBarMeter( "damageMeterBack" , 630, 75, 40, 375, "IFCFill_Red" );
      gameBackground.addVerticalBarMeter( "damageMeter" , 630, 75, 40, 375, "IFCFill_Green" );
   }
