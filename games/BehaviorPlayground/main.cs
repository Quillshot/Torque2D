...
if( !isFunction( "initializeProject" ) || !isFunction( "_initializeProject" ) )
{
   messageBox( "Game Startup Error", "'initializeProject' function could not be found." @
               "\nThis could indicate a bad core.zip file or overwritten replacements in the core directory." @
               "\n\nThe Game will now shutdown because it cannot properly function", "Ok", "Information" );
   quit();
}
